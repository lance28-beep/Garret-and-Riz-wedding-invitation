  ...
  return (
    <main className="min-h-screen bg-[#8498B0] relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <div
          className="absolute bottom-24 right-12 w-20 h-20 bg-[#E0CFB5]/26 rounded-full blur-2xl animate-pulse-slow"
        ...
        {/* Decorative lines */}
        <div className="absolute top-1/2 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#E0CFB5]/40 to-transparent" />
      </div>
