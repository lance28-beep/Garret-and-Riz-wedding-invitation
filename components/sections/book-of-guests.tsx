...
export function BookOfGuests() {
  ...
  return (
    <div 
      id="guests" 
      className="relative z-10 py-12 md:py-16 lg:py-20 overflow-hidden bg-gradient-to-br from-[#8498B0] via-[#8498B0] to-[#8498B0]"
    >
            ...
            <div className="relative bg-[#F7F5F1]/95 backdrop-blur-md border border-[#E0CFB5]/80 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 shadow-[0_20px_60px_rgba(0,0,0,0.45)] overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="bg-[#8498B0] p-1.5 sm:p-2 rounded-full shadow-lg">
            ...
            {isLoading ? (
              <div className="flex items-center justify-center py-12 sm:py-16">
                <div className="flex flex-col items-center gap-3">
                  <Loader2 className="h-8 w-8 sm:h-10 sm:w-10 animate-spin text-[#8498B0]" />
                  <span className={`${cormorant.className} text-[#243127] text-sm sm:text-base`}>Loading guests...</span>
                </div>
              </div>
            ) : error ? (
              <div className="flex items-center justify-center py-12 sm:py-16">
                <div className="text-center">
                  <MessageSquare className="h-8 w-8 sm:h-10 sm:w-10 text-red-600 mx-auto mb-3" />
              ...
              <div className="flex items-center justify-center py-12 sm:py-16">
                <div className="text-center">
                  <div className="bg-[#8498B0]/20 w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
                    <Heart className="h-6 w-6 sm:h-7 sm:h-7 text-[#8498B0]" />
                  </div>
              ...
              <div className="space-y-2 sm:space-y-3 relative">
                {guests.map((guest, index) => (
                  <div
                    key={index}
                    className="group relative bg-white rounded-md sm:rounded-lg p-2.5 sm:p-3 md:p-4 border border-[#8498B0]/20 hover:border-[#8498B0]/40 transition-all duration-300 hover:shadow-[0_4px_20px_rgba(132,152,176,0.15)] hover:shadow-lg"
                  >
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                      {/* Avatar */}
                      <div className="relative h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 flex-shrink-0">
                        <div className="h-full w-full rounded-full bg-[#8498B0] text-white flex items-center justify-center font-semibold shadow-md ring-2 ring-[#8498B0]/20 text-[10px] sm:text-xs md:text-sm">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1.5 sm:gap-2">
                          <div className="flex-1 min-w-0">
                            <h4 className={`${cormorant.className} text-sm sm:text-base md:text-lg font-semibold text-[#243127] mb-0.5 group-hover:text-[#8498B0] transition-colors duration-200 truncate`}>
                              {guest.Name}
                            </h4>
                            {guest.Email && guest.Email !== "Pending" && (
                              <div className="flex items-center text-[10px] sm:text-xs text-[#556457]">
                                <Mail className="h-2.5 w-2.5 sm:h-3 sm:w-3 mr-1 text-[#8498B0]/60 flex-shrink-0" />
                          ...
                          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                            <User className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-[#8498B0]/70 flex-shrink-0" />
                            <span className={`${cormorant.className} inline-flex items-center justify-center px-2 sm:px-2.5 py-0.5 sm:py-1 bg-[#8498B0]/10 text-[#8498B0] rounded-full text-[10px] sm:text-xs font-semibold border border-[#8498B0]/30 whitespace-nowrap`}>
                        ...
                        {/* Message */}
                        {guest.Message && (
                          <div className="mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-[#8498B0]/20">
                            <div className="flex items-start gap-1.5 sm:gap-2">
                              <MessageSquare className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-[#8498B0]/60 flex-shrink-0 mt-0.5" />
