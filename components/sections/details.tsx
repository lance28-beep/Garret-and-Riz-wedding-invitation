...
export function Details() {
  ...
  const receptionMapsLink = `https://maps.google.com/?q=${encodeURIComponent(siteConfig.reception.location)}`
    ...
    const sponsorPalette = ["#CBB3AF", "#C3BBB9"]
    const guestPalette = ["#C6C5CD", "#BFCFDF", "#E0D8CB"]
  ...
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
          {[
            ...
            },
            {
              ...
              gradient: "from-[#8498B0] via-[#BFCDD8] to-[#F1F1EF]",
              image: "/Details/Bulwagan de San Vicente.jpg",
            },
          ].map((info) => (
            <div
              key={info.key}
              className="overflow-hidden rounded-xl sm:rounded-2xl border border-[#F1F1EF]/25 bg-gradient-to-b shadow-[0_20px_60px_rgba(0,0,0,0.45)] transition-transform duration-500 group hover:scale-[1.01]"
            ...
            >
              ...
              <div className="relative h-52 sm:h-64 md:h-72 w-full">
                <Image
                  ...
                  priority
                />
                <div className={`absolute inset-0 bg-gradient-to-t from-[#8498B0]/95 via-[#8498B0]/65 to-transparent`} />
              ...
              {/* Details panel */}
              <div className="bg-[#F1F1EF]/95 text-[#8498B0] px-3 sm:px-6 py-4 sm:py-6 space-y-4 backdrop-blur-sm">
                <div className="space-y-2.5">
                  <div className="space-y-1">
                    <p className="text-xs sm:text-sm text-[#8498B0]/90 leading-relaxed">{info.location}</p>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-2 text-left">
                    <div className="rounded-md border border-[#E0CFB5] bg-white/80 px-2.5 py-2 shadow-sm">
                      <p className="text-[9px] sm:text-[10px] font-semibold tracking-[0.18em] text-[#8498B0] uppercase mb-0.5">
                        Date & Time
                      </p>
                      <p className="text-sm sm:text-base font-bold text-[#8498B0]">
                        {info.key === "ceremony" 
                    ...
                    <div className="rounded-md border border-[#E0CFB5] bg-white/80 px-2.5 py-2 shadow-sm">
                      ...
                      <p className="text-sm sm:text-base font-bold text-[#8498B0]">{info.venue}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 rounded-lg bg-[#8498B0] text-white py-2.5 sm:py-3 shadow-lg hover:translate-y-[-2px] transition-all text-xs sm:text-sm font-semibold"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 rounded-lg border border-[#8498B0]/35 text-[#8498B0] py-2.5 sm:py-3 hover:bg-[#8498B0]/5 transition-all text-xs sm:text-sm font-semibold"
                  >
    ...
    <div className="relative z-10 mb-4 sm:mb-7 max-w-4xl mx-auto px-3 sm:px-5">
        ...
        <div className="space-y-3 sm:space-y-4">
          {/* Attire Guidelines */}
          <div className="relative rounded-2xl border border-white/40 bg-white/85 backdrop-blur-lg shadow-[0_18px_40px_rgba(132,152,176,0.18)] p-3.5 sm:p-5 overflow-hidden">
            <div className="mb-2.5 sm:mb-3 relative z-10 text-center">
              <h4 className="text-[0.75rem] sm:text-sm md:text-base font-semibold tracking-[0.3em] uppercase text-[#8498B0]">
                Attire &amp; Motif
              </h4>
            </div>
                ...
                <div className="border-t border-[#E0CFB5] pt-4">
                  ...
                  <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
                    <p className="text-[#8498B0]">
                      <span className="font-semibold">Ninong:</span> Barong
                    </p>
                    <p className="text-[#8498B0]">
                      <span className="font-semibold">Ninang:</span> Long Dress
                    </p>
                    <div className="pt-1">
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="relative w-full rounded-2xl overflow-hidden border border-white/60 shadow-xl bg-white p-4 sm:p-6">
                <div className="mb-3 sm:mb-4">
                  <h4 className="text-[0.75rem] sm:text-sm md:text-base font-semibold tracking-[0.3em] uppercase text-[#8498B0] mb-3">
                    Arrival Time
                  </h4>
                  <div className="space-y-2 sm:space-y-2.5">
                    <p className="text-xs sm:text-sm text-[#8498B0] leading-relaxed">
                      Kindly arrive by <span className="font-semibold text-[#8498B0]">{siteConfig.ceremony.guestsTime}</span> so we can begin the wedding ceremony promptly at exactly <span className="font-semibold text-[#8498B0]">{siteConfig.ceremony.time}</span>.
                    </p>
                    <p className="text-xs sm:text-sm text-[#8498B0] leading-relaxed">
          ...
          {/* Travel & Parking - Compact, blue-gray & tan motif */}
          <div className="relative rounded-2xl border border-[#E0CFB5]/70 bg-[#F1F1EF]/90 backdrop-blur-lg shadow-[0_18px_40px_rgba(132,152,176,0.18)] p-3.5 sm:p-5 overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-center gap-2 mb-2.5 sm:mb-3 relative z-10">
              <div className="p-1.5 rounded-full shadow-md bg-white/95 border border-[#E0CFB5]/60">
                <Car className="w-3.5 h-3.5 text-[#8498B0]" />
              </div>
              <h4 className="font-semibold text-xs sm:text-base text-[#8498B0]">Parking &amp; Travel</h4>
            </div>

            <div className="space-y-3 relative z-10">
              {/* Parking */}
              <div className="rounded-xl p-2.5 sm:p-3 border border-[#E0CFB5]/80 bg-gradient-to-br from-white/95 via-[#F1F1EF]/95 to-white/90 shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-[#8498B0]/90 text-[#F1F1EF]">
                    <Car className="w-4 h-4" />
                  </div>
                  <div className="flex-1">
                    <p className="text-[11px] sm:text-sm font-semibold text-[#8498B0]">Parking Available</p>
                    <p className="text-[10px] sm:text-xs text-[#8498B0]/85">
              ...
              <div className="rounded-xl p-2.5 sm:p-3 border border-[#E0CFB5]/80 bg-gradient-to-br from-white/95 via-[#F1F1EF]/95 to-white/90 shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-[#BFCDD8]/90 text-[#3A4A5C]">
                    <Navigation className="w-4 h-4" />
                  </div>
                  <div className="flex-1">
                    <p className="text-[11px] sm:text-sm font-semibold text-[#8498B0]">Transportation</p>
                    <p className="text-[10px] sm:text-xs text-[#8498B0]/85">
              ...
              {/* Tips */}
              <div className="rounded-xl p-2.5 sm:p-3 border border-[#E0CFB5]/75 bg-gradient-to-br from-white/95 via-[#F1F1EF]/95 to-white/90">
                <p className="text-[11px] sm:text-sm font-semibold mb-2 flex items-center gap-2 text-[#8498B0]">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[#8498B0]/10 text-[#8498B0]">
                    <MapPin className="w-3.5 h-3.5" />
                  </span>
                  Quick Tips
                </p>
                <ul className="text-[10px] sm:text-xs space-y-1 text-[#8498B0]/90">
                  <li className="flex items-start gap-2">
                    <span className="text-[#8498B0] mt-0.5">•</span>
